...
## =================================
## Run: Rscript AV90002Standard.r rawData/split_AV9000Site 2, Inflow upstream_20131203.txt
##
...
source.instance <- "AV9000_Adliswil_2"
...
names(data.raw) <- c("Date Time", "Water Level", "Average Flow Velocity", "Flow", "Temperature", "Gain", "Battery Voltage")
